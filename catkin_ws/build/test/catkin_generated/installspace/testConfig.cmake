...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /Users/Saren/Documents/Uni/306/SpeedKiwi/catkin_ws/src/test)
  set(test_DEVEL_PREFIX /Users/Saren/Documents/Uni/306/SpeedKiwi/catkin_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /Users/Saren/Documents/Uni/306/SpeedKiwi/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Saren <Saren@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/Saren/Documents/Uni/306/SpeedKiwi/catkin_ws/install/${idir}'.  Ask the maintainer 'Saren <Saren@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /Users/Saren/Documents/Uni/306/SpeedKiwi/catkin_ws/install/lib;/Users/Saren/Documents/Uni/306/SpeedKiwi/catkin_ws/devel/lib;/Users/Saren/Documents/Uni/306/catkin_ws/devel/lib;/Users/Saren/ros_catkin_ws/install_isolated/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    find_package(${test_dep} REQUIRED ${depend_list})
  endif()
