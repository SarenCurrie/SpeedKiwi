...
def main(argv):
    ...
    rospy.init_node('RobotNode0', argv, anonymous=True)
    rate = rospy.Rate(10)
    ...
    node_stage_pub = rospy.Publisher("robot_0/cmd_vel", Twist, queue_size=1000)
    odo_stage_sub = rospy.Subscriber("robot_0/odom", Odometry, "StageOdom_callback")
    laser_stage_sub = rospy.Subscriber("robot_0/base_scan", LaserScan, "StageLaser_callback")
    count = 0
