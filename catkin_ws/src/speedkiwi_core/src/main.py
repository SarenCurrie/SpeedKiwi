...
picker1.add_action(MoveAction(1))
picker1.add_action(RotateAction("rotate_to_north"))
picker1.add_action(MoveAction(78))
picker1.add_action(RotateAction("rotate_to_east"))
picker1.add_action(MoveAction(3.5))
picker1.add_action(RotateAction("rotate_to_south"))
picker1.add_action(MoveAction(78))
picker1.add_action(RotateAction("rotate_to_west"))
picker1.add_action(MoveAction(3.5))
...
while not rospy.is_shutdown():
    ...
    person1.execute()
    person2.execute()
    binbot1.execute_callback()
    binbot2.execute_callback()
    binbot3.execute_callback()
    binbot4.execute_callback()
    picker1.execute()
    picker2.execute()
    picker3.execute()
